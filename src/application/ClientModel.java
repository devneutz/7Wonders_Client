...
public class ClientModel {
	...
	private void handleLobbyDeletedMessage(ServerLobbyMessage inMessage) {
		...
		// Ist die gelöschte Lobby diejenige, in der ich mich aktuell befinde? In diesem Fall muss die View über die 'lastReceivedMessage' informiert werden
	...
	/**
	 * Beim Startup handelt es sich um Login und Registrierungsprozesse. Diese werden in den Controllern durch entsprechende Listener 
	 * abgehandelt, da darauf zumeist eine UI Interaktion stattfindet.
	 * @param inMessage
	 */
	private void handleStartupMessages(ServerStartupMessage inMessage) {
		// Die letzte erhaltene Message wird gesetzt sprich, das Handling wird über den Listener gesteuert.
		lastReceivedMessage.setValue(inMessage);
	}
